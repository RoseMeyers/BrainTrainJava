...
/*
 * A user input run program that will ask the user fill in the blank, 
 * true/false, and multiple choice questions on multiple subjects.
 */
...
public class Main {
  /**
   * promptAnswer will prompt the user to enter their answer.
   */
