...
/*
 * A user input run program that will ask the user fill in the blank, true/false, and multiple
 * choice questions on multiple subjects.
 */

package integrationproject;

// Renamed and refactored package name to all lowercase but "mismatch pattern" bug 
...
public class Main {
  ...
  /*
   * promptAnswer will print the first name given by the user
   */
